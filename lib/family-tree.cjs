...
(FamilyTree._defaultConfig = function (e) {
  ...
  (FamilyTree.manager._createNodes = function (e) {
    ...
    for (c = 0; c < C.length; c++) {
      ...
      (g.partnerSeparation =
        Math.max(O.length, B.length) * t.partnerChildrenSplitSeparation +
    ...
    for (var $ in w) {
      ...
      for (F = b.children.length - 1; F >= 0; F--) {
        (R = b.children[F]).isAssistant
          ? ((R.parent = null), b.children.splice(F, 1), Y.splice(0, 0, R.id))
          : R.isPartner ||
            (R.parent &&
              S[R.parent.id] &&
              j &&
        ...
        if (
          ...
          if (
            ...
            for (c = ie.childrenIds.length - 1; c >= 0; c--) {
              for (R = o[ie.childrenIds[c]], F = 0; F < b.children.length; F++)
                b.children[F].id == R.id && b.children.splice(F, 1);
              if (
                ((R.parent = null),
  ...
  (FamilyTree.remote._findRegion = function (e) {
    const t = FamilyTree.localStorage.getItem("funcUrl");
    if (t) e(t);
    else {
      for (
        var i = [
        ...
        !(function () {
          ...
          (n.onreadystatechange = function () {
            if (4 == this.readyState && 200 == this.status) {
              ...
              for (let i = 0; i < r.length; i++) r[i].abort();
            }
          }),
            n.open("GET", t, !0),
            n.send();
